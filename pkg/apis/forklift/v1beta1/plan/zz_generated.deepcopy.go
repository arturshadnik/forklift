...
func (in *DiskDelta) DeepCopyInto(out *DiskDelta) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DiskDelta.
func (in *DiskDelta) DeepCopy() *DiskDelta {
	if in == nil {
		return nil
	}
	out := new(DiskDelta)
...
func (in *VM) DeepCopyInto(out *VM) {
	*out = *in
	...
	out.LUKS = in.LUKS
	out.OvaEnvConfigMap = in.OvaEnvConfigMap
}
...
func (in *Warm) DeepCopyInto(out *Warm) {
	*out = *in
	if in.NextPrecopyAt != nil {
		in, out := &in.NextPrecopyAt, &out.NextPrecopyAt
		*out = (*in).DeepCopy()
	}
	if in.Precopies != nil {
		in, out := &in.Precopies, &out.Precopies
		*out = make([]Precopy, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
